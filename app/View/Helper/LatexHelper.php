...
class LatexHelper extends AppHelper {
  
    var $path_to_latex   = '/usr/bin/latex';
    var $path_to_dvips   = '/usr/bin/dvips';
    var $path_to_convert = '/usr/bin/convert';

    var $imgfmt="png"; #literally used in extensions, and in parameters to convert. Should be either png or gif.
