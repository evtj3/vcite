	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Student\'s Logs'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('name', 'Student Name'); ?></th>
				...
				<tbody>
				<?php foreach ($logs as $teacher): ?>
					<tr>
						<td><?php echo h($teacher['Log']['name']); ?>&nbsp;</td>
						<td><?php echo h($teacher['Log']['activity']); ?>&nbsp;</td>
						<td><?php echo h($teacher['Log']['created']); ?>&nbsp;</td>
						<td><?php echo h($teacher['Log']['modified']); ?>&nbsp;</td>
