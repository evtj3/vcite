					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Topic'), array('action' => 'add'), array('escape' => false)); ?></li>
				...
				<?php foreach ($topics as $topic): ?>
					<tr>
						<td><?php echo h($topic['Topic']['id']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($topic['Subject']['title'], array('controller' => 'subjects', 'action' => 'view', $topic['Subject']['id'])); ?>
		</td>
