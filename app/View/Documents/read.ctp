                                   		...
                                   		<?php foreach($folderName as $fn):?>
		                                   	...
		                                   	<li>
		                                   		...
		                                   		<b>
		                                   			...
		                                   			<a href="#" data-toggle="modal" data-target="#adddocfile<?php echo $countFolder;?>" title="add files"><span class="glyphicon glyphicon-plus"></span></a>
		                                   			<?php endif;?>
		                                   		</b>
		                                   	</li>
			                                <hr/>
		                                   	<li style="padding-left:30px;">
	                                   			<ul style="font-size:14px;">
	                                   				...
	                                   				<?php $count += 1;?>
	                                   				<li><span class="glyphicon glyphicon-link">&nbsp;<?php echo $count;?>. <a href="<?php echo $df['link'];?>"></span> <?php echo $df['title'];?>
	                                   				<?php if($this->Session->read('User.group') == 'teacher'):?>
	                                   				 | <a href="<?php echo $this->Html->url(array('controller' => 'docfiles','action' => 'delete/'.$df['id']));?>" title="remove"><span class="glyphicon glyphicon-remove"></span></a>
	                                   				<?php endif;?>
	                                   				</a>
	                                   				</li>
