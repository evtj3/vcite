	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li class="active">ISO Documents</li>
			</ol>
		</div>
	</div>
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
                                ...
                                <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;Add Document'), array('controller' => 'documents', 'action' => 'add'), array('escape' => false)); ?> </li>
	                               <?php endif;?>
							</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
						...
						<div class="panel-heading">
							...
							<div id="dropmenu" class="btn-group" style="float: right; top: -6px; right: -10px;">
								...
								<ul class="dropdown-menu pull-right" role="menu">
									<li><a href="<?php echo $this->Html->url(array('controller' => 'documents', 'action' => 'edit', $d['Document']['id'])); ?>" style="color: #12AD2B;"><span class="glyphicon glyphicon-edit"></span>&nbsp;Edit</a></li>
									<li><a href="<?php echo $this->Html->url(array('controller' => 'documents', 'action' => 'remove', $d['Document']['id'])); ?>" style="color: #FF6141;"><span class="glyphicon glyphicon-trash"></span>&nbsp;Remove</a></li>
								</ul>
								
							</div>
							<?php endif;?>
							<span class="date_created"><?php echo $d['Document']['created']; ?></span>
						</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li class="box-description no-border">
                                   ...
                                   <ul class="nav nav-pills nav-stacked">
                                   		<li class="box-description">
											...
											<?php echo $d['Document']['description']; ?>
											<br><br>
											<div style="padding: 5px 0 0; font-size: 12px;">
												<span class="glyphicon glyphicon-list-alt"></span> <?php echo count($d['Docfile']); ?> 
												PDF Files
											</div>
											
                                   			<?php if($this->Session->read('User.group') == 'student'):?>
                                   			<a href="<?php echo $this->Html->url(array('controller' => 'documents', 'action' => 'read?doc='.$d['Document']['title'].'&docid='.$d['Document']['id'])); ?>" class="btn btn-default " role="button" style="float: right;">
												<span class="glyphicon glyphicon-list-alt"></span>
												Open
											</a>
                                   			<?php elseif($this->Session->read('User.group') == 'teacher'):?>
                                   			<a href="<?php echo $this->Html->url(array('controller' => 'documents', 'action' => 'view?doc='.$d['Document']['title'].'&docid='.$d['Document']['id'])); ?>" class="btn btn-default " role="button" style="float: right;">
												<span class="glyphicon glyphicon-list-alt"></span>
												Open
											</a>
                                   			<?php endif;?>
