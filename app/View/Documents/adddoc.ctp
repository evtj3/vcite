	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li ><a href="<?php echo $this->Html->url(array('controller' => 'documents', 'action' => 'view?doc='.$this->params['url']['doc'].'&docid='.$this->params['url']['docid'])); ?>" title="Back to Index">
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
                                <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-arrow-left"></span>&nbsp&nbsp;Back'), array('controller' => 'documents', 'action' => 'view?doc='.$this->params['url']['doc'].'&docid='.$this->params['url']['docid']), array('escape' => false)); ?> </li>
							</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
		...
		<div class="col-md-9">
				...
				<div class="form-group">
					...
					<?php echo $this->Form->input('lasdocid', array('type' => 'hidden','class' => 'form-control'));?>
					<?php echo $this->Form->input('foldername', array('class' => 'form-control', 'placeholder' => 'Folder Name', 'requireds'));?>
				</div>
				
				<div class="form-group">
					<?php echo $this->Form->submit(__('Create'), array('class' => 'btn btn-default')); ?>
				</div>
