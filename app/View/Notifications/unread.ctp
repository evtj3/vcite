	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li class="active"><?php echo 'Unread'; ?></li>
			</ol>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-md-9">
			<p style="font-style:italic; font-size:10px;">Total Unread notifications: <?php echo count($notifs);?></p>
			<?php foreach($notifs as $unread):?>
				<div class="actions" id="DescriptionBox">
					
					<div class="panel panel-default">
						
							<div class="panel-heading">
								<?php echo 'Sender: '.$unread['Notification']['sender'];?>
							</div>
							<div class="panel-body">
								<div class="subquickMenu_notif">
									...
									<?php 
										...
										$limitStr = 23;
										$strContent = $unread['Notification']['content'];
										$list = '';
										
										$list = substr($strContent,0,$limitStr);
										if(strlen($strContent) <= $limitStr){
										echo $list;}
										else{
										echo $list.'...';}
									?>

									<p style="font-size:10px;float:right;"><?php echo $unread['Notification']['modified'];?></p>
									<p style="font-size:14px;">[<a href="<?php echo $this->Html->url(array('controller' => 'notifications','action' => 'notifs',$unread['Notification']['id']));?>"> read </a>]</p>
								</div>
							</div><!-- end body -->
