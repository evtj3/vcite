<div class="subjects form">
	...
	<div class="row">
		...
		<div class="col-md-9">
				<?php echo $this->Form->create('Docfoldertree', array('role' => 'form','action' => 'add')); ?>
				<div class="form-group">
					<?php echo $this->Form->input('doc', array('value'=>$this->params['url']['doc'],'type' => 'hidden','class' => 'form-control'));?>
					<?php echo $this->Form->input('docid', array('type' => 'hidden','class' => 'form-control'));?>
					<?php echo $this->Form->input('lasdocid', array('value'=>$this->params['url']['docid'],'type' => 'hidden','class' => 'form-control'));?>
					<?php echo $this->Form->input('foldername', array('class' => 'form-control', 'placeholder' => 'Folder Name', 'requireds'));?>
					
				</div>
				
				<div class="form-group">
					<?php echo $this->Form->submit(__('Create'), array('name' => 'submit_create','class' => 'btn btn-default')); ?>
				</div>
			...
			<?php echo $this->Form->create('Docfoldertree', array('role' => 'form','action' => 'add')); ?>
				<div class="form-group">
					<?php echo $this->Form->input('doc', array('value'=>$this->params['url']['doc'],'type' => 'hidden','class' => 'form-control'));?>
					<?php echo $this->Form->input('lasdocid', array('value'=>$this->params['url']['docid'],'type' => 'hidden','class' => 'form-control'));?>
					<select name="exist_folders" class="form-control">
						<?php foreach($folderTrees as $d):?>
							<?php if(!empty($d['Docfoldertree']['lasdoc_id']) && !strpos($d['Docfoldertree']['lasdoc_id'],$this->params['url']['docid'])):?>

								<option value="<?php echo $d['Docfoldertree']['id'];?>"><?php echo $d['Docfoldertree']['foldername'];?></option>
				...
				<div class="form-group">
					<?php echo $this->Form->submit(__('Use this folder'), array('name' => 'submit_usefolder','class' => 'btn btn-default')); ?>
				</div>
