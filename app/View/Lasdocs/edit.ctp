	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li ><a href="<?php echo $this->Html->url(array('controller' => 'documents', 'action' => 'add')); ?>" title="Back to Index">
					ISO Documents</a></li>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
                                <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-arrow-left"></span>&nbsp&nbsp;Back to index'), array('controller' => 'documents', 'action' => 'index'), array('escape' => false)); ?> </li>
							</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
		...
		<div class="col-md-9">
				...
				<div class="form-group">
					<?php echo $this->Form->input('title', array('value' => $docs['Document']['title'],'class' => 'form-control', 'placeholder' => 'Title', 'requireds'));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('description', array('value' => $docs['Document']['description'],'class' => 'form-control', 'placeholder' => 'Description'));?>
				</div>
				<!--
				<div class="form-group">
