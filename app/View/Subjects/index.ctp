	...
	<div class="row">
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('cover_img'); ?></th>
			...
			<?php echo $this->Html->link($subject['Teacher']['id'], array('controller' => 'teachers', 'action' => 'view', $subject['Teacher']['id'])); ?>
						...
						<td><?php echo h($subject['Subject']['cover_img']); ?>&nbsp;</td>
						...
						<td class="actions">
							...
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $subject['Subject']['id']), array('escape' => false)); ?>
