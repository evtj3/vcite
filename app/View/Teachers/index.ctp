			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('fname', 'Teacher Name'); ?></th>
						<th><?php echo $this->Paginator->sort('email'); ?></th>
						<th><?php echo $this->Paginator->sort('pword', 'Password'); ?></th>
				...
				<?php foreach ($teachers as $teacher): ?>
					<tr>
						...
						<td><?php echo h($teacher['Teacher']['fname'].' '.$teacher['Teacher']['lname']); ?>&nbsp;</td>
