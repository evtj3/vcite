...
class PagesController extends AppController {
	...
	public function login(){
       ...
       // pr($cakeSesData);
        ...
        //load json data
		    ...
		    $url = $server.$this->Session->read('User.portal').'class_advisories/show_sections';
			$url2 = '';
			$datas = "";
        ...
        if(!empty($SISdataArr)){
			...
			//checking login
				...
				header('Location: http://'.$serverName.$this->Session->read('User.portal'));
				exit();
			}
	...
	*/
	public function logout() {
		...
		header('Location: http://'.$serverName.$this->Session->read('User.portal').'pages');
		exit();
